...
//	public static Item emerald;
	public static Item ruby = new Item(2300).setUnlocalizedName("gemRuby").setCreativeTab(CreativeTabs.tabMaterials);
	public static Item saphir = new Item(2301).setUnlocalizedName("gemSaphir").setCreativeTab(CreativeTabs.tabMaterials);
	public static Item opal = new Item(2302).setUnlocalizedName("gemOpal").setCreativeTab(CreativeTabs.tabMaterials);
	public static Item topas = new Item(2303).setUnlocalizedName("gemTopas").setCreativeTab(CreativeTabs.tabMaterials);
	public static Item onyx = new Item(2304).setUnlocalizedName("gemOnyx").setCreativeTab(CreativeTabs.tabMaterials);
	public static Item quartz = new Item(2305).setUnlocalizedName("gemQuartz").setCreativeTab(CreativeTabs.tabMaterials);
	public static Item amethyst = new Item(2306).setUnlocalizedName("gemAmethyst").setCreativeTab(CreativeTabs.tabMaterials);
	public static Item achat = new Item(2307).setUnlocalizedName("gemAchat").setCreativeTab(CreativeTabs.tabMaterials);

	// Metalle
	public static Item ingotCopper = new Item(2308).setUnlocalizedName("ingotCopper").setCreativeTab(CreativeTabs.tabMaterials);
	public static Item ingotCin = new Item(2309).setUnlocalizedName("ingotCopper").setCreativeTab(CreativeTabs.tabMaterials);
	public static Item ingotBronze = new Item(2310).setUnlocalizedName("ingotCopper").setCreativeTab(CreativeTabs.tabMaterials);
	public static Item ingotSilver = new Item(2311).setUnlocalizedName("ingotCopper").setCreativeTab(CreativeTabs.tabMaterials);
	public static Item ingotCobalt = new Item(2312).setUnlocalizedName("ingotCopper").setCreativeTab(CreativeTabs.tabMaterials);
	public static Item ingotMithril = new Item(2313).setUnlocalizedName("ingotCopper").setCreativeTab(CreativeTabs.tabMaterials);
	public static Item ingotAdamantite = new Item(2314).setUnlocalizedName("ingotCopper").setCreativeTab(CreativeTabs.tabMaterials);
	public static Item ingotOrichalcum = new Item(2315).setUnlocalizedName("ingotCopper").setCreativeTab(CreativeTabs.tabMaterials);
	public static Item ingotElectrum = new Item(2316).setUnlocalizedName("ingotCopper").setCreativeTab(CreativeTabs.tabMaterials);
	
	public static Item copperNugget = new Item(2317).setUnlocalizedName("ingotCopper").setCreativeTab(CreativeTabs.tabMaterials);
	public static Item nuggetIron = new Item(2318).setUnlocalizedName("ingotCopper").setCreativeTab(CreativeTabs.tabMaterials);
    ...
    public static Item swordDiamond = (new ItemSword(20, EnumToolMaterial.DIAMOND)).setUnlocalizedName("swordDiamond");
    public static Item shovelDiamond = (new ItemSpade(21, EnumToolMaterial.DIAMOND)).setUnlocalizedName("shovelDiamond");
    public static Item pickaxeDiamond = (new ItemPickaxe(22, EnumToolMaterial.DIAMOND)).setUnlocalizedName("pickaxeDiamond");
    public static Item axeDiamond = (new ItemAxe(23, EnumToolMaterial.DIAMOND)).setUnlocalizedName("hatchetDiamond");
    ...
    public static Item hoeDiamond = (new ItemHoe(37, EnumToolMaterial.DIAMOND)).setUnlocalizedName("hoeDiamond");
	...
	// Werkzeuge, Rüstungen und Waffen
	// Schwerter
	public static Item swordCopper = new ItemSword(2319, EnumToolMaterial.COPPER).setUnlocalizedName("swordCopper").setCreativeTab(CreativeTabs.tabCombat);
	public static Item swordCin = new ItemSword(2320, EnumToolMaterial.CIN).setUnlocalizedName("swordCin").setCreativeTab(CreativeTabs.tabCombat);
	public static Item swordSilver = new ItemSword(2321, EnumToolMaterial.SILVER).setUnlocalizedName("swordSilver").setCreativeTab(CreativeTabs.tabCombat);
	public static Item swordBronze = new ItemSword(2322, EnumToolMaterial.BRONZE).setUnlocalizedName("swordBronze").setCreativeTab(CreativeTabs.tabCombat);
	public static Item swordCobalt = new ItemSword(2323, EnumToolMaterial.COBALT).setUnlocalizedName("swordCobalt").setCreativeTab(CreativeTabs.tabCombat);
	public static Item swordMithril = new ItemSword(2324, EnumToolMaterial.MITHRIL).setUnlocalizedName("swordMithril").setCreativeTab(CreativeTabs.tabCombat);
	public static Item swordAdamantite = new ItemSword(2325, EnumToolMaterial.ADAMANTITE).setUnlocalizedName("swordAdamantite").setCreativeTab(CreativeTabs.tabCombat);
	public static Item swordOrichalcum = new ItemSword(2326, EnumToolMaterial.ORICHALCUM).setUnlocalizedName("swordOrichalcum").setCreativeTab(CreativeTabs.tabCombat);
	public static Item swordElectrum = new ItemSword(2327, EnumToolMaterial.ELECTRUM).setUnlocalizedName("swordElectrum").setCreativeTab(CreativeTabs.tabCombat);

	public static Item swordRuby = new ItemSword(2328, EnumToolMaterial.RUBY).setUnlocalizedName("swordRuby").setCreativeTab(CreativeTabs.tabCombat);
	public static Item swordSaphir = new ItemSword(2329, EnumToolMaterial.SAPHIR).setUnlocalizedName("swordSaphir").setCreativeTab(CreativeTabs.tabCombat);
	public static Item swordTopas = new ItemSword(2330, EnumToolMaterial.TOPAS).setUnlocalizedName("swordTopas").setCreativeTab(CreativeTabs.tabCombat);
	public static Item swordEmerald = new ItemSword(2331, EnumToolMaterial.EMERALD).setUnlocalizedName("swordEmerald").setCreativeTab(CreativeTabs.tabCombat);
	public static Item swordAmethyst = new ItemSword(2332, EnumToolMaterial.AMETHYST).setUnlocalizedName("swordAmethyst").setCreativeTab(CreativeTabs.tabCombat);
	public static Item swordOnyx = new ItemSword(2333, EnumToolMaterial.ONYX).setUnlocalizedName("swordOnyx").setCreativeTab(CreativeTabs.tabCombat);
	public static Item swordAchat = new ItemSword(2334, EnumToolMaterial.ACHAT).setUnlocalizedName("swordAchat").setCreativeTab(CreativeTabs.tabCombat);
	
	// Helme
	public static Item helmetCopper = new ItemArmor(2335, EnumArmorMaterial.COPPER, 5, 1).setUnlocalizedName("helmetCopper").setCreativeTab(CreativeTabs.tabCombat);
	public static Item helmetCin = new ItemArmor(2336, EnumArmorMaterial.CIN, 6, 1).setUnlocalizedName("helmetCopper").setCreativeTab(CreativeTabs.tabCombat);
	public static Item helmetBronze = new ItemArmor(2337, EnumArmorMaterial.COPPER, 7, 1).setUnlocalizedName("helmetCopper").setCreativeTab(CreativeTabs.tabCombat);
	public static Item helmetSilver = new ItemArmor(2338, EnumArmorMaterial.COPPER, 8, 1).setUnlocalizedName("helmetCopper").setCreativeTab(CreativeTabs.tabCombat);
	public static Item helmetCobalt = new ItemArmor(2339, EnumArmorMaterial.COPPER, 9, 1).setUnlocalizedName("helmetCopper").setCreativeTab(CreativeTabs.tabCombat);
	public static Item helmetMithril = new ItemArmor(2340, EnumArmorMaterial.COPPER, 10, 1).setUnlocalizedName("helmetCopper").setCreativeTab(CreativeTabs.tabCombat);
	public static Item helmetAdamantite = new ItemArmor(2341, EnumArmorMaterial.COPPER, 11, 1).setUnlocalizedName("helmetCopper").setCreativeTab(CreativeTabs.tabCombat);
	public static Item helmetOrichalcum = new ItemArmor(2342, EnumArmorMaterial.COPPER, 12, 1).setUnlocalizedName("helmetCopper").setCreativeTab(CreativeTabs.tabCombat);
	public static Item helmetElectrum = new ItemArmor(2343, EnumArmorMaterial.COPPER, 13, 1).setUnlocalizedName("helmetCopper").setCreativeTab(CreativeTabs.tabCombat);

	public static Item helmetRuby = new ItemArmor(2344, EnumArmorMaterial.COPPER, 14, 1).setUnlocalizedName("helmetCopper").setCreativeTab(CreativeTabs.tabCombat);
	public static Item helmetSaphir = new ItemArmor(2345, EnumArmorMaterial.COPPER, 15, 1).setUnlocalizedName("helmetCopper").setCreativeTab(CreativeTabs.tabCombat);
	public static Item helmetTopas = new ItemArmor(2346, EnumArmorMaterial.COPPER, 16, 1).setUnlocalizedName("helmetCopper").setCreativeTab(CreativeTabs.tabCombat);
	public static Item helmetEmerald = new ItemArmor(2347, EnumArmorMaterial.COPPER, 17, 1).setUnlocalizedName("helmetCopper").setCreativeTab(CreativeTabs.tabCombat);
	public static Item helmetAmethyst = new ItemArmor(2348, EnumArmorMaterial.COPPER, 18, 1).setUnlocalizedName("helmetCopper").setCreativeTab(CreativeTabs.tabCombat);
	public static Item helmetOnyx = new ItemArmor(2349, EnumArmorMaterial.COPPER, 19, 1).setUnlocalizedName("helmetCopper").setCreativeTab(CreativeTabs.tabCombat);
	public static Item helmetAchat = new ItemArmor(2350, EnumArmorMaterial.COPPER, 20, 1).setUnlocalizedName("helmetCopper").setCreativeTab(CreativeTabs.tabCombat);
	
	// Brustplatten
	public static Item plateCopper;
	public static Item plateCin;
	public static Item plateBronze;
	public static Item plateSilver;
	public static Item plateCobalt;
	public static Item plateMithril;
	public static Item plateAdamantite;
	public static Item plateOrichalcum;
	public static Item plateElectrum;

	public static Item plateRuby;
	public static Item plateSaphir;
	public static Item plateTopas;
	public static Item plateEmerald;
	public static Item plateAmethyst;
	public static Item plateOnyx;
	public static Item plateAchat;
	
	// Beinschienen
	public static Item legsCopper;
	public static Item legsCin;
	public static Item legsBronze;
	public static Item legsSilver;
	public static Item legsCobalt;
	public static Item legsMithril;
	public static Item legsAdamantite;
	public static Item legsOrichalcum;
	public static Item legsElectrum;

	public static Item legsRuby;
	public static Item legsSaphir;
	public static Item legsTopas;
	public static Item legsEmerald;
	public static Item legsAmethyst;
	public static Item legsOnyx;
	public static Item legsAchat;
	
	// Schuhe
	public static Item bootsCopper;
	public static Item bootsCin;
	public static Item bootsBronze;
	public static Item bootsSilver;
	public static Item bootsCobalt;
	public static Item bootsMithril;
	public static Item bootsAdamantite;
	public static Item bootsOrichalcum;
	public static Item bootsElectrum;

	public static Item bootsRuby;
	public static Item bootsSaphir;
	public static Item bootsTopas;
	public static Item bootsEmerald;
	public static Item bootsAmethyst;
	public static Item bootsOnyx;
	public static Item bootsAchat;
	
	// Äxte
	public static Item axeCopper;
	public static Item axeCin;
	...
	public static Item hoeElectrum;
	
	public static Item hoeRuby;
	public static Item hoeSaphir;
	public static Item hoeTopas;
	public static Item hoeEmerald;
	public static Item hoeAmethyst;
	public static Item hoeOnyx;
	public static Item hoeAchat;
	
	// Schmelzbare Gemische
	public static Item copperAndCin;
	public static Item mithrilAndOrich;
	
	// Holzeimer
	public static Item woodenBucketEmpty = new ItemWoodenBucket(2530, 0).setUnlocalizedName("woodenBucketEmpty").setCreativeTab(CreativeTabs.tabMisc);
	public static Item woodenBucketWater = new ItemWoodenBucket(2531, Block.waterMoving.blockID).setUnlocalizedName("woodenBucketWater").setContainerItem(woodenBucketEmpty).setCreativeTab(CreativeTabs.tabMisc);
	public static Item woodenBucketMilk = new ItemWoodenBucketMilk(2532).setUnlocalizedName("woodenBucketMilk").setContainerItem(woodenBucketEmpty).setCreativeTab(CreativeTabs.tabMisc);
	
	// Geschirr
	public static Item silverBowl = new Item(2600).setUnlocalizedName("silverBowl");
	public static Item goldenBowl = new Item(2601).setUnlocalizedName("goldenBowl");
	public static Item woodenPlate = new Item(2602).setUnlocalizedName("woodenPlate");
	public static Item silverPlate = new Item(2603).setUnlocalizedName("silverPlate");
	public static Item goldenPlate = new Item(2604).setUnlocalizedName("goldenPlate");
	public static Item glass = new Item(2605).setUnlocalizedName("glass");
	
	// Essen
	public static Item pumpkinSoupWooden = new ItemSoup(2610, 6).setUnlocalizedName("pumpkinSoupWooden").setContainerItem(Item.bowlEmpty).setCreativeTab(CreativeTabs.tabFood);
	public static Item pumpkinSoupSilver = new ItemSoup(2611, 7).setUnlocalizedName("pumpkinSoupSilver").setContainerItem(Item.silverBowl).setCreativeTab(CreativeTabs.tabFood);
	public static Item pumpkinSoupGolden = new ItemSoup(2612, 8).setUnlocalizedName("pumpkinSoupGolden").setContainerItem(Item.goldenBowl).setCreativeTab(CreativeTabs.tabFood);
	
	public static Item mushroomStewSilver = new ItemSoup(2613, 7).setUnlocalizedName("mushroomStewSilver").setContainerItem(Item.silverBowl).setCreativeTab(CreativeTabs.tabFood);
	public static Item mushroomStewGolden = new ItemSoup(2614, 8).setUnlocalizedName("mushroomStewGolden").setContainerItem(Item.goldenBowl).setCreativeTab(CreativeTabs.tabFood);
     ...
     * player's inventory instead of remaining in the crafting grid.
     */
    public boolean doesContainerItemLeaveCookingGrid(ItemStack par1ItemStack)
    {
        return true;
    }
