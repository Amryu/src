...
public class EntityPlayerMP extends EntityPlayer implements ICrafting, ICooking
{
    ...
    public void addSelfToInternalCookingInventory()
    {
        this.openContainer.addCookingToCookers(this);
    }
    ...
    public void onUpdate()
    {
        ...
        this.openContainer.detectAndSendCraftingChanges();
    ...
    {
    	System.out.println("displayGUIKitchen");
    	this.incrementWindowID();
        this.playerNetServerHandler.sendPacketToPlayer(new Packet100OpenWindow(this.currentWindowId, 11, "Cooking", 9, true));
        this.openContainer = new ContainerKitchen(this.inventory, this.worldObj, par1, par2, par3);
        this.openContainer.windowId = this.currentWindowId;
        this.openContainer.addCookingToCookers(this);
    }
    ...
    public void closeInventory()
    {
        ...
        this.openContainer.onKitchenGuiClosed(this);
