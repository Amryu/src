...
public class InventoryPlayer implements IInventory
{
    ...
    /** An array of 4 item stacks containing the currently worn equip pieces. */
    public ItemStack[] equipInventory = new ItemStack[4];
    ...
    public int clearInventory(int par1, int par2)
    {
        ...
        for (var4 = 0; var4 < this.equipInventory.length; ++var4)
        {
            var5 = this.equipInventory[var4];

            if (var5 != null && (par1 <= -1 || var5.itemID == par1) && (par2 <= -1 || var5.getItemDamage() == par2))
            {
                var3 += var5.stackSize;
                this.equipInventory[var4] = null;
            }
        }
    ...
    public ItemStack decrStackSize(int par1, int par2)
    {
        ...
        if (par1 >= mainInventory.length + armorInventory.length)
        {
        	var3 = equipInventory;
            par1 -= mainInventory.length + armorInventory.length;
        }
    ...
    /**
     * Sets the given item stack to the specified slot in the inventory (can be crafting, armor or equip sections).
     */
    public void setInventorySlotContents(int par1, ItemStack par2ItemStack)
    {
        ...
        if (par1 >= var3.length + armorInventory.length)
        {
            par1 -= var3.length + armorInventory.length;
            var3 = equipInventory;
        }
    ...
    public NBTTagList writeToNBT(NBTTagList par1NBTTagList)
    {
        ...
        for (var2 = 0; var2 < this.equipInventory.length; ++var2)
        {
            if (this.equipInventory[var2] != null)
            {
                var3 = new NBTTagCompound();
                var3.setByte("Slot", (byte)(var2 + 200));
                this.equipInventory[var2].writeToNBT(var3);
                par1NBTTagList.appendTag(var3);
            }
        }
    ...
    public void readFromNBT(NBTTagList par1NBTTagList)
    {
        ...
        this.equipInventory = new ItemStack[4];
        ...
        for (int var2 = 0; var2 < par1NBTTagList.tagCount(); ++var2)
        {
            ...
            if (var5 != null)
            {
                ...
                if (var4 >= 200 && var4 < this.equipInventory.length + 200)
                {
                    this.equipInventory[var4 - 200] = var5;
                }
            }
        }
    }
    ...
    {
        return this.mainInventory.length + 4 + 4;
    }
    ...
    public ItemStack getStackInSlot(int par1)
    {
        ...
        if (par1 >= var2.length + armorInventory.length)
        {
            par1 -= var2.length + armorInventory.length;
            var2 = equipInventory;
        }
    ...
    /**
     * returns a player equip item (as itemstack) contained in specified equip slot.
     */
    public ItemStack equipItemInSlot(int par1)
    {
        return this.equipInventory[par1];
    }
    ...
    public void dropAllItems()
    {
        ...
        for (var1 = 0; var1 < this.equipInventory.length; ++var1)
        {
            if (this.equipInventory[var1] != null)
            {
                this.player.dropPlayerItemWithRandomChoice(this.equipInventory[var1], true);
                this.equipInventory[var1] = null;
            }
        }
    }
    ...
    public boolean hasItemStack(ItemStack par1ItemStack)
    {
        ...
        for (var2 = 0; var2 < this.equipInventory.length; ++var2)
        {
            if (this.equipInventory[var2] != null && this.equipInventory[var2].isItemEqual(par1ItemStack))
            {
                return true;
            }
        }
    ...
    public void copyInventory(InventoryPlayer par1InventoryPlayer)
    {
        ...
        for (var2 = 0; var2 < this.equipInventory.length; ++var2)
        {
            this.equipInventory[var2] = ItemStack.copyItemStack(par1InventoryPlayer.equipInventory[var2]);
        }
