...
public class ItemSword extends Item implements IUpgradeable
{
    ...
    {
        return this.getToolMaterial().getDamageVsEntity();
    }
    ...
    {
        return this.getToolMaterial().getToolCraftingMaterial() == par2ItemStack.itemID ? true : super.getIsRepairable(par1ItemStack, par2ItemStack);
    }
