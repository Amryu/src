...
public class GuiInventory extends InventoryEffectRenderer
{
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
    {
        ...
        String attack = Minecraft.getMinecraft().thePlayer.getCombatData()[0][0]+"";
    	mc.fontRenderer.drawString(attack, ((int)xSize / 2 - mc.fontRenderer.getStringWidth(attack)) + 67 + guiLeft, ((int)ySize / 2) -66 + guiTop, 0xff0000);

    	String defense =  Minecraft.getMinecraft().thePlayer.getCombatData()[1][0]+"";
    	mc.fontRenderer.drawString(defense, ((int)xSize / 2 - mc.fontRenderer.getStringWidth(defense)) + 84 + guiLeft, ((int)ySize / 2) -66 + guiTop, 0x0000ff);
    }
