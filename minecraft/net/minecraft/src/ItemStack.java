...
public final class ItemStack
{
    ...
    public void onCooking(World par1World, EntityPlayer par2EntityPlayer, int par3)
    {
        par2EntityPlayer.addStat(StatList.objectCookStats[this.itemID], par3);
        Item.itemsList[this.itemID].onCreated(this, par1World, par2EntityPlayer);
    }
    ...
    public NBTTagList getUpgradeTagList()
    {
        return this.stackTagCompound == null ? null : (NBTTagList)this.stackTagCompound.getTag("upgrade");
    }
    ...
    public List getTooltip(EntityPlayer par1EntityPlayer, boolean par2)
    {
        ...
        NBTTagList var2 = this.getUpgradeTagList();
        
        if(var2 != null) {
	        int upgradeLevel = 0;
	        
	        for (int i = 0; i < getUpgradeTagList().tagCount(); i++) {
	            upgradeLevel = ((NBTTagCompound)var2.tagAt(i)).getShort("lvl");
	        }
     ...
     * Adds an enchantment with a desired level on the ItemStack.
     */
    public void addUpgrade(int level)
    {
        ...
        if (!this.stackTagCompound.hasKey("upgrade"))
        {
            this.stackTagCompound.setTag("upgrade", new NBTTagList("upgrade"));
        }

        NBTTagList var3 = (NBTTagList)this.stackTagCompound.getTag("upgrade");
        NBTTagCompound var4 = new NBTTagCompound();
