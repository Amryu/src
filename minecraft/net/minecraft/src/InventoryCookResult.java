...
public class InventoryCookResult implements IInventory
{
    private ItemStack stackResult[];
    
    ContainerKitchen cont;

    public InventoryCookResult(ContainerKitchen cont)
    {
    ...
    public void onInventoryChanged()
    {
    	...
    	{
    		cont.invDishes.onInventoryChanged();
    		cont.removeIngredients();
    	}
    }
