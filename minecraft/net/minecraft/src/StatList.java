...
public class StatList
{
    ...
    /** Tracks the number of items a given block or item has been crafted. */
    public static StatBase[] objectCookStats;
    ...
    public static void initCraftableStats()
    {
        if (blockStatsInitialized && itemStatsInitialized)
        {
            ...
            // TODO
//            objectCookStats = new StatBase[32000];
//            var1 = var0.iterator();
//
//            while (var1.hasNext())
//            {
...
//                if (Item.itemsList[var5.intValue()] != null)
//                {
//                    String var3 = StatCollector.translateToLocalFormatted("stat.cookItem", new Object[] {Item.itemsList[var5.intValue()].getStatName()});
//                    objectCookStats[var5.intValue()] = (new StatCrafting(16842752 + var5.intValue(), var3, var5.intValue())).registerStat();
//                }
//            }
//
//            replaceAllSimilarBlocks(objectCookStats);
        }
    }
