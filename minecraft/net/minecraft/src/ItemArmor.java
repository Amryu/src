...
public class ItemArmor extends Item implements IUpgradeable
{
    ...
    {
        return this.getMaterial() == EnumArmorMaterial.CLOTH;
    }
    ...
    {
        return this.getMaterial() != EnumArmorMaterial.CLOTH ? false : (!par1ItemStack.hasTagCompound() ? false : (!par1ItemStack.getTagCompound().hasKey("display") ? false : par1ItemStack.getTagCompound().getCompoundTag("display").hasKey("color")));
    }
    ...
    {
        if (this.getMaterial() != EnumArmorMaterial.CLOTH)
        {
            return -1;
        }
        else
    ...
    {
        return this.getMaterial().getArmorCraftingMaterial() == par2ItemStack.itemID ? true : super.getIsRepairable(par1ItemStack, par2ItemStack);
    }
