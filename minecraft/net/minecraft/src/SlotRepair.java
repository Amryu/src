...
class SlotRepair extends Slot
{
    ...
    public void onPickupFromSlot(EntityPlayer par1EntityPlayer, ItemStack par2ItemStack)
    {
        ...
        if (ContainerRepair.getStackSizeUsedInRepair(this.anvil) > 0)
        {
            ...
            if (ContainerRepair.getRepairInputInventory(this.anvil).getStackInSlot(1).getItem() == Item.quartz) {
            	var3.stackSize -= 1;
            	ContainerRepair.getRepairInputInventory(this.anvil).setInventorySlotContents(1, var3);
            	par2ItemStack = par2ItemStack.upgrade(par2ItemStack);
            }
            else if (var3 != null && var3.stackSize > ContainerRepair.getStackSizeUsedInRepair(this.anvil))
            {
