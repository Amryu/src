...
public class ContainerPlayer extends Container
{
    ...
    public ContainerPlayer(InventoryPlayer par1InventoryPlayer, boolean par2, EntityPlayer par3EntityPlayer)
    {
        ...
        this.addSlotToContainer(new SlotCrafting(par1InventoryPlayer.player, this.craftMatrix, this.craftResult, 0, 110, 62));
        int var4;
        int var5;
        ...
        for (var4 = 0; var4 < 2; ++var4)
        {
            ...
            {
                this.addSlotToContainer(new Slot(this.craftMatrix, var5 + var4 * 2, 101 + var5 * 18, 8 + var4 * 18));
            }
        }

        for (var4 = 0; var4 < 4; ++var4)
        {
        	System.out.println(par1InventoryPlayer.getSizeInventory() - 5 - var4);
            this.addSlotToContainer(new SlotArmor(this, par1InventoryPlayer, par1InventoryPlayer.getSizeInventory() - 5 - var4, 8, 8 + var4 * 18, var4));
        }
        ...
        for (var4 = 0; var4 < 3; ++var4)
        {
            ...
            {
            	System.out.println(var5 + (var4 + 1) * 9);
        ...
        for (var4 = 0; var4 < 4; ++var4)
        {
        	System.out.println(par1InventoryPlayer.getSizeInventory() - 1 - var4);
            this.addSlotToContainer(new SlotEquip(this, par1InventoryPlayer, par1InventoryPlayer.getSizeInventory() - 1 - var4, 80, 8 + var4 * 18, var4));
        }
     ...
     */
    public void onWorkbenchGuiClosed(EntityPlayer par1EntityPlayer)
    {
        super.onWorkbenchGuiClosed(par1EntityPlayer);
