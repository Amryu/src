...
public abstract class Container
{
    ...
    protected List cookers = new ArrayList();
    ...
    public void addCraftingToCrafters(ICrafting par1ICrafting)
    {
        ...
        else
        {
            ...
            this.detectAndSendCraftingChanges();
        }
    }
    
    public void addCookingToCookers(ICooking par1ICooking)
    {
        if (this.cookers.contains(par1ICooking))
        {
            throw new IllegalArgumentException("Listener already listening");
        }
        else
        {
            this.cookers.add(par1ICooking);
            par1ICooking.sendContainerAndContentsToPlayer(this, this.getInventory());
            this.detectAndSendCookingChanges();
        }
    }
     ...
     * Remove this crafting listener from the listener list.
     */
    public void removeCookingFromCookers(ICooking par1ICooking)
    {
        this.cookers.remove(par1ICooking);
    }
     ...
     */
    public void detectAndSendCraftingChanges()
    {
     ...
     * Looks for changes made in the container, sends them to every listener.
     */
    public void detectAndSendCookingChanges()
    {
        for (int var1 = 0; var1 < this.inventorySlots.size(); ++var1)
        {
            ItemStack var2 = ((Slot)this.inventorySlots.get(var1)).getStack();
            ...
            if (!ItemStack.areItemStacksEqual(var3, var2))
            {
                ...
                for (int var4 = 0; var4 < this.crafters.size(); ++var4)
                {
                    ((ICooking)this.cookers.get(var4)).sendSlotContents(this, var1, var3);
                }
            }
        }
    }
