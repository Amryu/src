...
public class BiomeDecorator
{
	...
	protected WorldGenerator copperGen 		= new WorldGenMinable(Block.oreCopper.blockID, 10);
	protected WorldGenerator cinGen 		= new WorldGenMinable(Block.oreCin.blockID, 10);
	protected WorldGenerator silverGen 		= new WorldGenMinable(Block.oreSilver.blockID, 6);
	protected WorldGenerator cobaltGen 		= new WorldGenMinable(Block.oreCobalt.blockID, 5);
	protected WorldGenerator mithrilGen 	= new WorldGenMinable(Block.oreMithril.blockID, 4);
	protected WorldGenerator adamantiteGen  = new WorldGenMinable(Block.oreAdamantite.blockID, 4);
	protected WorldGenerator orichalcumGen 	= new WorldGenMinable(Block.oreOrichalcum.blockID, 2);
	protected WorldGenerator emeraldGen 	= new WorldGenMinable(Block.oreEmerald.blockID, 5);
	protected WorldGenerator rubyGen 		= new WorldGenMinable(Block.oreRuby.blockID, 5);
	protected WorldGenerator saphirGen 		= new WorldGenMinable(Block.oreSaphir.blockID, 5);
	protected WorldGenerator topasGen 		= new WorldGenMinable(Block.oreTopas.blockID, 5);
	protected WorldGenerator opalGen 		= new WorldGenMinable(Block.oreOpal.blockID, 5);
	protected WorldGenerator onyxGen 		= new WorldGenMinable(Block.oreOnyx.blockID, 5);
	protected WorldGenerator quartzGen 		= new WorldGenMinable(Block.oreQuartz.blockID, 5);
	protected WorldGenerator amethystGen 	= new WorldGenMinable(Block.oreAmethyst.blockID, 5);
	protected WorldGenerator achatGen 		= new WorldGenMinable(Block.oreAchat.blockID, 5);
    ...
    protected void generateOres()
    {
        ...
        this.genStandardOre1(25, this.copperGen, 0, 64);
        this.genStandardOre1(25, this.cinGen, 0, 64);
        this.genStandardOre1(5 , this.silverGen, 0, 48);
        this.genStandardOre1(2 , this.cobaltGen, 0, 24);
        this.genStandardOre1(1 , this.mithrilGen, 0, 16);
        if(ran.nextInt(3) != 0) this.genStandardOre1(1 , this.adamantiteGen, 0, 16);
        if(ran.nextInt(2) == 0) this.genStandardOre1(1 , this.orichalcumGen, 0, 16);
        if(ran.nextInt(2) == 0) this.genStandardOre1(1 , this.emeraldGen, 0, 48);
        if(ran.nextInt(2) == 0)  this.genStandardOre1(1 , this.rubyGen, 0, 16);
        if(ran.nextInt(2) == 0) this.genStandardOre1(1 , this.saphirGen, 0, 48);
        if(ran.nextInt(2) == 0) this.genStandardOre1(1 , this.topasGen, 0, 32);
        if(ran.nextInt(2) == 0) this.genStandardOre1(1 , this.opalGen, 0, 32);
        if(ran.nextInt(2) == 0) this.genStandardOre1(1 , this.onyxGen, 0, 16);
        if(ran.nextInt(2) == 0) this.genStandardOre1(2 , this.quartzGen, 0, 32);
        if(ran.nextInt(2) == 0) this.genStandardOre1(1 , this.amethystGen, 0, 16);
        if(ran.nextInt(2) == 0) this.genStandardOre1(1 , this.achatGen, 0, 32);
    }
}
