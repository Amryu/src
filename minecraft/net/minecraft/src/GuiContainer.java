...
public abstract class GuiContainer extends GuiScreen
{
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        for (int var13 = 0; var13 < this.inventorySlots.inventorySlots.size(); ++var13)
        {
            ...
            {
            	System.out.println(var14.slotNumber);
                this.theSlot = var14;
                GL11.glDisable(GL11.GL_LIGHTING);
                GL11.glDisable(GL11.GL_DEPTH_TEST);
        ...
        if (par1 >= 143 + guiLeft && par2 >= 28 + guiTop && par1 <= 152 + guiLeft && par2 <= 37 + guiTop ||
        	par1 >= 156 + guiLeft && par2 >= 28 + guiTop && par1 <= 165 + guiLeft && par2 <= 37 + guiTop ||
        	par1 >= 143 + guiLeft && par2 >= 41 + guiTop && par1 <= 152 + guiLeft && par2 <= 50 + guiTop ||
        	par1 >= 156 + guiLeft && par2 >= 41 + guiTop && par1 <= 165 + guiLeft && par2 <= 50 + guiTop ||
        	par1 >= 143 + guiLeft && par2 >= 54 + guiTop && par1 <= 152 + guiLeft && par2 <= 63 + guiTop ||
        	par1 >= 156 + guiLeft && par2 >= 54 + guiTop && par1 <= 165 + guiLeft && par2 <= 63 + guiTop ||
        	par1 >= 143 + guiLeft && par2 >= 69 + guiTop && par1 <= 152 + guiLeft && par2 <= 78 + guiTop ||
        	par1 >= 156 + guiLeft && par2 >= 69 + guiTop && par1 <= 165 + guiLeft && par2 <= 78 + guiTop)
        {
        	String element = "";
        	int elementarAttack = 0;
        	int elementarResist = 0;
        	if(par1 >= 143 + guiLeft && par2 >= 28 + guiTop && par1 <= 152 + guiLeft && par2 <= 37 + guiTop) {
        		element = "Feuer"; elementarAttack = mc.thePlayer.fireAttack; elementarResist = mc.thePlayer.fireResist;
        	}
        	if(par1 >= 156 + guiLeft && par2 >= 28 + guiTop && par1 <= 165 + guiLeft && par2 <= 37 + guiTop) {
        		element = "Wasser"; elementarAttack = mc.thePlayer.waterAttack; elementarResist = mc.thePlayer.waterResist;
        	}
        	if(par1 >= 143 + guiLeft && par2 >= 41 + guiTop && par1 <= 152 + guiLeft && par2 <= 50 + guiTop) {
        		element = "Erd"; elementarAttack = mc.thePlayer.earthAttack; elementarResist = mc.thePlayer.earthResist;
        	}
        	if(par1 >= 156 + guiLeft && par2 >= 41 + guiTop && par1 <= 165 + guiLeft && par2 <= 50 + guiTop) {
        		element = "Luft"; elementarAttack = mc.thePlayer.windAttack; elementarResist = mc.thePlayer.windResist;
        	}
        	if(par1 >= 143 + guiLeft && par2 >= 54 + guiTop && par1 <= 152 + guiLeft && par2 <= 63 + guiTop) {
        		element = "Licht"; elementarAttack = mc.thePlayer.lightAttack; elementarResist = mc.thePlayer.lightResist;
        	}
        	if(par1 >= 156 + guiLeft && par2 >= 54 + guiTop && par1 <= 165 + guiLeft && par2 <= 63 + guiTop) {
        		element = "Finsternis"; elementarAttack = mc.thePlayer.darkAttack; elementarResist = mc.thePlayer.darkResist;
        	}
        	if(par1 >= 143 + guiLeft && par2 >= 69 + guiTop && par1 <= 152 + guiLeft && par2 <= 78 + guiTop) {
        		element = "Blitz"; elementarAttack = mc.thePlayer.thunderAttack; elementarResist = mc.thePlayer.thunderResist;
        	}
        	if(par1 >= 156 + guiLeft && par2 >= 69 + guiTop && par1 <= 165 + guiLeft && par2 <= 78 + guiTop) {
        		element = "Eis"; elementarAttack = mc.thePlayer.iceAttack; elementarResist = mc.thePlayer.iceResist;
        	}
            ArrayList<String> list = new ArrayList<String>();
            list.add(String.valueOf(element+"angriff: "+elementarAttack));
            list.add(String.valueOf(element+"abwehr: " +elementarResist));
            
            func_102021_a(list, par1 - guiLeft, par2 - guiTop);
        }
    ...
    public void onGuiClosed()
    {
        ...
        {
            this.inventorySlots.onWorkbenchGuiClosed(this.mc.thePlayer);
            this.inventorySlots.onKitchenGuiClosed(this.mc.thePlayer);
        }
    }
